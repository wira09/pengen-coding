      ...
      <details className="group relative overflow-hidden rounded-lg border border-slate-300 bg-white shadow-sm">
        ...
        <div className="divide-y divide-slate-300 border-t border-slate-300 bg-white">
          ...
          <fieldset className="p-3">
            ...
            <div className="flex flex-col items-start gap-3">
              <label htmlFor="html" className="inline-flex items-center gap-3">
                <input
                  type="checkbox"
                  className="size-5 rounded border-slate-300 bg-white shadow-sm"
                  id="html"
              ...
              <label htmlFor="css" className="inline-flex items-center gap-3">
                <input
                  type="checkbox"
                  className="size-5 rounded border-slate-300 bg-white shadow-sm"
                  id="css"
              ...
              <label htmlFor="react" className="inline-flex items-center gap-3">
                <input
                  type="checkbox"
                  className="size-5 rounded border-slate-300 bg-white shadow-sm"
                  id="react"
