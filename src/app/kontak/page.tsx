      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Jangan ragu untuk menghubungi kami jika ada pertanyaan, saran, atau
            ingin berdiskusi seputar dunia IT dan pemrograman.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4 p-4 rounded-lg hover:bg-amber-50 transition-colors duration-200">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Indonesia</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                {/* <a href="#" className="bg-gray-100 hover:bg-indigo-100 p-3 rounded-full transition-colors duration-200">
                  <svg className="w-5 h-5 text-gray-700 hover:text-indigo-600" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                  </svg>
                </a> */}
                <a
                  href="#"
                  className="bg-amber-100 hover:bg-amber-200 p-3 rounded-full transition-colors duration-200"
                >
                  <svg
                    className="w-5 h-5 text-amber-600 hover:text-amber-700"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-amber-500 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
              >
                Kirim Pesan
              </button>
            </form>
