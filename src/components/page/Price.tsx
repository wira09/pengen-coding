  ...
  const priceSection: PriceSection[] = [
    {
      ...
      price: "50K",
      title: "Next.js Fundamental ",
      stack: "Next.js (Javascript / Typescript, Supabase)",
      descriptions: [
        "Belajar Next.js dari nol (App Router & Component)",
        "Dasar routing, layout, dan protected page",
        "Implementasi rest api + multi role (admin & user)",
        "Mini project Next.js dengan auth & role",
      ],
